...
7) restecg: Result of electrocardiogram while at rest are represented in 3 distinct values
   0 : Normal | 1: having ST-T wave abnormality (T wave inversions and/or ST elevation or depression of > 0.05 mV) | 2: showing
   probable or definite left ventricular hypertrophyby Estes' criteria (Nominal)
...
13) thal: A blood disorder called thalassemia
    0: NULL | 1: normal blood flow | 2: fixed defect (no blood flow in some part of the heart) | 3: reversible defect (a blood flow is
    observed but it is not normal(nominal)
14) num: It is the target variable which we have to predict 1 means patient is suffering from heart disease and 0 means patient is normal.
